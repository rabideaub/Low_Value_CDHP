...
***************************************************************************/
	if conf_id='' & '70000'<=:proc[i]<=:'79999' then imaging=1;
	if conf_id='' then imaging_den=1;

	if conf_id='' & '80000'<=:proc[i]<=:'90000' then laboratory=1;
	if conf_id='' then laboratory_den=1;

	if conf_id='' then non_inpatient=1;
	if conf_id='' then non_inpatient_den=1;
...
proc univariate data=out.low_value_procs;
